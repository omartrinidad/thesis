...
Notice that there are two terms:

\begin{itemize}
    \item $| dom(\body) \cap dom(r_h) |$ and
    \item $\#y_{per\ x}$
\end{itemize}
...
The second term is more complex to explain will reshape the formula.
...
SANSA~\cite{lehmann-2017-sansa-iswc} is a platform whose purpose is\ldots A similar work to SANSA is S2RDF~\cite{schatzle2016s2rdf}.
